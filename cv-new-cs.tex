...
\section{Zkušenosti}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Vyvinul jsem aplikaci pro vytváření faktur v účetním systému Pohoda pro studenty, což vedlo k výraznému zjednodušení procesu fakturace a zvýšení efektivity účetního oddělení.}
